...
public class DessinForet {
    ...
    public void dessinerForet(ParseXml parser,Pane pane, ArrayList<ForetData> P, String viile ,Circle[] selectedCircle,Converter converter){
        P = parser.parserforet(viile);

        for (int i = 0; i < P.size(); i++) {

            ForetData parkData = (ForetData) P.get(i);
